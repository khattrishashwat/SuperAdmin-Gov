          ...
          <div className="card stretch stretch-full">
            <div className="card-body task-header d-lg-flex align-items-center justify-content-between">
              <div className="mb-4 mb-lg-0">
                <h4 className="mb-3 fw-bold text-truncate-1-line">
                  sk || CRM Applications & Admin Dashboar
                </h4>
          ...
          <div className="card stretch stretch-full">
            ...
            <div className="card-body">
              <p>
                ...
                company that specializes in designing and creating websites.
                These companies typically offer a range of services including
                website design, development, and maintenance. They may also
                offer other related services such as search engine optimization
                (SEO), e-commerce solutions, and website hosting.
              </p>
              <ul className="list-unstyled text-muted mb-0">
                ...
                <li className="d-flex align-items-start mb-3">
                  ...
                  <span>
                    ...
                    to various development teams. This lead to 100% bug-free
                    deployment.{" "}
                  </span>
                </li>
                <li className="d-flex align-items-start mb-3">
                  ...
                  <span>
                    Introduced Kanban Board style ticketing system to promote
                    highly efficient asynchronous and synchronous work,
                    increasing efficiency by 12%.{" "}
                  </span>
                </li>
                <li className="d-flex align-items-start mb-3">
                  <span className="avatar-text avatar-sm bg-soft-success text-success me-3">
                  ...
                  <span>
                    ...
                    landing pages for both company and client.{" "}
                  </span>
                </li>
                <li className="d-flex align-items-start mb-3">
                  <span className="avatar-text avatar-sm bg-soft-success text-success me-3">
          ...
          <div className="card stretch stretch-full">
            <div className="card-header">
              ...
              <Dropdown
                ...
                triggerPosition={"25, 25"}
                tooltipTitle={"Options"}
                dropdownItems={checkListOptions}
              />
            </div>
            ...
            <div className="card-body">
              <div className="row">
                <div className="col-xxl-6">
                  <Card title="How to upload data to the system?" link="#" />
                  <Card title="How to draw a land plot on a map?" link="#" />
                  <Card title="How to to view expire services?" link="#" />
                  <Card
            ...
            <div className="card-body task-info">
              <div className="mb-4">
                ...
                <span className="fs-12 fw-normal text-muted d-block">
                  Created at 2023-02-12 08:47:47
                </span>
              </div>
              <div className="task-info-list">
                <div className="row align-items-center mb-3 task-list-row">
                  ...
                  <div className="col-6 d-flex">
                    <span className="border-bottom border-bottom-dashed border-gray-5">
                      In Progress
                    </span>
                    <Dropdown
                      triggerIcon={<FiEdit3 />}
          ...
          <div className="card stretch stretch-full">
            <div className="card-body task-tags">
              <div className="mb-4">
                ...
                <span className="fs-12 fw-normal text-muted d-block">
                  Tags label for tasks
                </span>
              </div>
              <MultiSelectTags
                options={tags}
                defaultSelect={[tags[0], tags[3], tags[8], tags[6]]}
              />
            </div>
          </div>
          <div className="card stretch stretch-full">
            <div className="card-body task-assignees">
              <div className="mb-4">
                ...
                <span className="fs-12 fw-normal text-muted d-block">
                  Assigne member to this tasks
                </span>
              </div>
              <MultiSelectImg
                options={taskAssigneeOptions}
                defaultSelect={[
                  taskAssigneeOptions[1],
                  taskAssigneeOptions[3],
                  taskAssigneeOptions[4],
                ]}
              />
            </div>
          </div>
