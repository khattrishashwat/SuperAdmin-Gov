...
const todos = [
  ...
  {
    time: "02:50",
    title: "Add files to new design folder",
    dueIn: 5,
    badgeColor: "success",
    badgeText: "New",
  },
            ...
            return (
              <Fragment key={index}>
                <div className="d-flex align-items-center">
                  ...
                  <div
                    className={`d-flex align-items-center justify-content-between border-3 border-start border-${badgeColor} rounded w-100`}
                  >
                    <div className="mx-3">
                      <a
                        href="#"
                        className="fw-semibold mb-1 text-truncate-1-line"
                      >
                        {title}
                      </a>
                    ...
                    <a
                      href="#"
                      className={`badge bg-soft-${badgeColor} text-${badgeColor}`}
                    >
                      {badgeText}
                    </a>
                  </div>
