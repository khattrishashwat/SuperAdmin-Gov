...
const ticketData = [
  ...
  {
    ticketNumber: "963258",
    title: "Live stream for bpl live",
    date: "20/02/2023",
    description: "Lorem ipsum dolor, sit amet consectetur adipisicing elit.",
  },
  {
  ...
  {
    ticketNumber: "456987",
    title: "sk public announcement",
    date: "20/02/2023",
    description: "Lorem ipsum dolor, sit amet consectetur adipisicing elit.",
  },
  {
    ticketNumber: "369852",
    title: "Marketing meeting with clients",
    date: "20/02/2023",
    description: "Lorem ipsum dolor, sit amet consectetur adipisicing elit.",
  },
];
        ...
        <div className="card-body custom-card-action p-0">
          <div className="table-responsive tickets-items-wrapper">
            <table className="table table-hover mb-0">
              ...
              <tbody>
                {ticketData.map(
                  ({ date, description, ticketNumber, title }, index) => (
                    <tr key={index}>
                      <td>
                      ...
                      <td>
                        ...
                        <p className="fs-12 text-muted text-truncate-1-line tickets-sort-desc">
                          {description}
                        </p>
