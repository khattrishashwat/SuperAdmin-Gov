...
const tasksData = [
  {
    ...
    assignee: taskAssigneeOptions,
  },
  {
    taskNumber: "02",
    taskName: "Live stream for bpl live ",
    taskDate: "20/02/2023",
    taskDescription:
      "Lorem ipsum dolor, sit amet consectetur adipisicing elit.",
    status: taskStatusOptions,
  ...
  {
    taskNumber: "04",
    taskName: "sk public pnnouncement ",
    taskDate: "20/02/2023",
    taskDescription:
      "Lorem ipsum dolor, sit amet consectetur adipisicing elit.",
    status: taskStatusOptions,
  ...
  {
    taskNumber: "05",
    taskName: "Marketing meeting with clients ",
    taskDate: "20/02/2023",
    taskDescription:
      "Lorem ipsum dolor, sit amet consectetur adipisicing elit.",
    status: taskStatusOptions,
...
const Tasks = ({ title }) => {
  ...
  const defaultAssigneeList = [
    ...
    "nneth.une@gmail.com",
    "erna.serpa@outlook.com",
  ];
  return (
    <div className="col-xxl-12">
      <div
        className={`card stretch stretch-full widget-tasks-content ${
                ...
                {tasksData.map(
                  (
                    ...
                    const statusValue = status.find(
                      (v) => v.value === defaultStatusList[index]
                    );
                    const priorityValue = priority.find(
                      (v) => v.value === defaultPriorityList[index]
                    );
                    const assigneeValue = assignee.find(
                      (v) => v.value === defaultAssigneeList[index]
                    );
                    return (
                      <tr key={index}>
                        <td>
                          <div className="avatar-text bg-gray-200">
                            {taskNumber}
                          </div>
                        </td>
                        <td>
                          ...
                          <p className="fs-12 text-muted mt-2 text-truncate-1-line tasks-sort-desc">
                            {taskDescription}
                          </p>
