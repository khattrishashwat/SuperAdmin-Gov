    ...
    <div className="tab-pane fade" id="v-pills-features" role="tabpanel">
      <div className="row g-4 nxl-mega-menu-miscellaneous-features">
        <div className="col-xl-8">
          <div className="row g-4">
            <Card
              icon={<FiBell />}
              title={"Notifications"}
              icon_bg={"bg-soft-primary text-primary border-soft-primary"}
            />
            <Card
              icon={<FiBarChart2 />}
              title={"Analytics"}
              icon_bg={"bg-soft-danger text-danger border-soft-danger"}
            />
            <Card
              icon={<FiLink2 />}
              title={"Ingetrations"}
              icon_bg={"bg-soft-success text-success border-soft-success"}
            />
            <Card
              icon={<FiBook />}
              title={"Documentations"}
              icon_bg={"bg-soft-indigo text-indigo border-soft-indigo"}
            />
            <Card
              icon={<FiShield />}
              title={"Security"}
              icon_bg={"bg-soft-warning text-warning border-soft-warning"}
            />
            <Card
              icon={<FiLifeBuoy />}
              title={"Support"}
              icon_bg={"bg-soft-teal text-teal border-soft-teal rounded"}
            />
          </div>
        </div>
        <div className="col-xxl-3 offset-xxl-1 col-xl-4">
          ...
          <div className="mt-4">
            <a href="mailto:wrapcoders@gmail.com" className="fs-13 fw-bold">
              View all features on sk &rarr;
            </a>
          </div>
        </div>
      </div>
      ...
      <div className="d-flex align-items-start gap-3">
        ...
        <div>
          ...
          <p className="fs-12 fw-normal text-muted mb-0 text-truncate-2-line">
            ...
            rem dignissimos. elit Unde numquam rem dignissimos.
          </p>
        </div>
      </div>
    </div>
