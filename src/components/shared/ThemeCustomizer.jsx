...
const fontFalmily = [
  ...
  {
    isChecked: false,
    value: "app-font-family-montserrat",
    label: "Montserrat",
  },
  {
    isChecked: false,
    value: "app-font-family-josefin-sans",
    label: "Josefin Sans",
  },
  {
    isChecked: false,
    value: "app-font-family-ibm-plex-sans",
    label: "Ibm Plex Sans",
  },
  {
    isChecked: false,
    value: "app-font-family-source-sans-pro",
    label: "Source Sans Pro",
  },
  {
    isChecked: false,
    value: "app-font-family-montserrat-alt",
    label: "Montserrat Alt",
  },
  {
    isChecked: false,
    value: "app-font-family-roboto-slab",
    label: "Roboto Slab",
  },
];
const ThemeCustomizer = () => {
  ...
  const handleFontFamily = (font, id) => {
    const existingFontClass =
      document.documentElement.classList.value.match(/app-font-family-\w+/);
        ...
        <div className="customizer-sidebar-body position-relative p-4">
          <PerfectScrollbar>
            ...
            <div className="position-relative px-3 pb-3 pt-4 mt-3 mb-5 border border-gray-2 theme-options-set">
              ...
              >
                <div
                  className="col-6 text-center single-option"
                  onClick={() => handleNavigationTheme("light")}
                >
                  <input
                    type="radio"
                    className="btn-check"
                ...
                <div
                  className="col-6 text-center single-option"
                  onClick={() => handleNavigationTheme("dark")}
                >
                  <input
                    type="radio"
                    className="btn-check"
            ...
            <div className="position-relative px-3 pb-3 pt-4 mt-3 mb-5 border border-gray-2 theme-options-set mt-5">
              ...
              >
                <div
                  className="col-6 text-center single-option"
                  onClick={() => handleHeaderTheme("light")}
                >
                  <input
                    type="radio"
                    className="btn-check"
                ...
                <div
                  className="col-6 text-center single-option"
                  onClick={() => handleHeaderTheme("dark")}
                >
                  <input
                    type="radio"
                    className="btn-check"
            ...
            <div className="position-relative px-3 pb-3 pt-4 mt-3 mb-5 border border-gray-2 theme-options-set">
              ...
              >
                <div
                  className="col-6 text-center position-relative single-option light-button"
                  onClick={() => handleSkinTheme("light")}
                >
                  <input
                    type="radio"
                    className="btn-check"
                ...
                <div
                  className="col-6 text-center position-relative single-option dark-button"
                  onClick={() => handleSkinTheme("dark")}
                >
                  <input
                    type="radio"
                    className="btn-check"
