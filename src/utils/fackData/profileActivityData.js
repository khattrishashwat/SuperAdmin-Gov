...
export const profileActivityData2 = [
  {
    ...
    description:
      "sk is a clean bootstrap admin dashboard, frontend and webapps template pack that built with most popular bootstrap framework and modern technology's.",
    badges: [
  ...
  },
  {
    ...
    description:
      "Check out our special promotion for this week. Limited time offer!",
    badges: [
