...
import Eduroamhome from "../pages/eduroamhome";
import DNS from "../pages/dnshome";
import Web from "../pages/webhostinghome";
import Email from "../pages/emailhostinghome";
import Ticket from "../pages/ticketinghome";
